  ...
  <div className="bg-white shadow-lg rounded-lg p-8 max-w-2xl w-full">
    ...
    <form className="space-y-4" onSubmit={handleSubmit}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <label className="block text-black font-medium">WhatsApp Number</label>
          <input
            type="text"
            name="whatsappNumber"
      ...
      <div>
        <label className="block text-black font-medium mb-2">Select Book Category</label>
      ...
      {subcategories.length > 0 && (
        <div className="mt-4">
          <label className="block text-black font-medium mb-2">Select Subcategory</label>
          <select
            name="subcategory"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label className="block text-black font-medium">Drive Link of Book Index</label>
          <input
            type="text"
            name="driveLink"
